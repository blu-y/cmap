...
wget https://huggingface.co/apple/DFN2B-CLIP-ViT-L-14/resolve/main/open_clip_pytorch_model.bin -O ./ViT-L-14-DFN2B/open_clip_pytorch_model.bin
wget https://huggingface.co/apple/DFN5B-CLIP-ViT-H-14/resolve/main/open_clip_pytorch_model.bin -O ./ViT-H-14-DFN5B/open_clip_pytorch_model.bin