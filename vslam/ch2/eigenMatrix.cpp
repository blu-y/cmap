...
int main(int argc, char **argv) {
  ...
  // Its first thress parameters are: data type, row, column Declare a 2*3 float matrix
  ...
  // We can easily multiply a matrix with a vector (but actually still matrices and matricess)
  v_3d << 3, 2, 1;
  vd_3d << 4, 5, 6;
  ...
  // This basic operations are not demonstrated, just use +-*/ operators.
  ...
  // For positive definite matrices, you can alse use cholesky decomposition to solve equations.
  time_stt = clock();
