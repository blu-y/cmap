...
def plot(df_s, label_list, show=False, save=False):
    for l in label_list:
        ...
        plt.tight_layout()
        if save:
            plt.savefig('clip_jetson_'+l+'.png')
            print('result saved as clip_jetson_'+l+'.png')
    if show:
        plt.show()
...
if __name__ == '__main__':
    ...
    plot(df_s, label_list = labels, save=True)